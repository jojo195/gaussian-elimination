...
colors = ['#0089FF', '#FF7700', '#009900', '#FF0000']
width = 0.2
...
for t in x_ticks:
    for first in range(len(Algorithms)):
        plt.bar(t+width*first, data[Algorithms[first]][x_data[t-1]], width=width, color = colors[first])
plt.legend(Algorithms)
# plt.bar(0, cpu_speed, width=0.5)
            
plt.savefig("omp_pthread_comp.jpg")
